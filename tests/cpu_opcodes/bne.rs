...
#[test]
fn test_0xd0_bne_will_branch_because_zero_flag_is_clear() {
  // arrange
  ...
  let program = vec![
    ...
    sec_value,
    0x00,
  ]; // LDA #$EF; CMP #$EF; BNE #$04; ADC #$01; ADC #$01; BRK
  let mut cpu = CPU::new();
...
#[test]
fn test_0xd0_bne_will_not_branch_because_zero_flag_is_set() {
  // arrange
  let expected_status_flags = 0b1000_0000;
  let acc_value = 0xEF;
  let sec_value = 0x01;
  ...
  let program = vec![
    ...
    sec_value,
    0x00,
  ]; // LDA #$EF; CMP #$AA; BNE #$04; ADC #$01; ADC #$01; BRK
  let mut cpu = CPU::new();
